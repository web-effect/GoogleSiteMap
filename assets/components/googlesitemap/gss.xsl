...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    <html>     
      <head>  
        ...
        <link href="/assets/components/googlesitemap/gss.css" type="text/css" rel="stylesheet"/>
        <script src="/assets/components/googlesitemap/gss.js"></script>  
      </head>
        ...
        <table class="copyright" id="table_copyright">
          <tr>
            <td>
              ...
              <p><a href="http://www.gnu.org/copyleft/lesser.html"><img src="/assets/components/googlesitemap/lgplv3.png" alt="LGPL" border="0"/></a> | <a href="http://sourceforge.net/projects/gstoolbox"><img src="/assets/components/googlesitemap/sourceforge.png" alt="SourceForge.net" border="0"/></a></p>
            </td>
          </tr>
        </table>
      </body>
  ...
  <xsl:template name="siteindexTable">
    ...
    <table width="100%" class="data" id="table0">
      <tr class="header">
        <td>Sitemap URL</td>
